...
public final class AIfzTerm extends PTerm
{
    private TIf _if_;
    private TId _cond_;
    ...
    public AIfzTerm(
        ...
        @SuppressWarnings("hiding") TZ _z_,
    ...
    public void setZ(TZ node)
    {
        if(this._z_ != null)
        {
            this._z_.parent(null);
        }
